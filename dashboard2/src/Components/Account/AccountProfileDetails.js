...
const AccountProfileDetails = (props) => {
    ...
    const updaterestaurantName = async (restaurantName) => {
        try {
            const rawres = await fetch(`${API_SERVICE}/api/v1/main/user/updaterestaurantName`, {
                method: 'PATCH',
                headers: {
    ...
    const updaterestaurantAddress = async (restaurantaddress) => {
        try {
            const rawres = await fetch(`${API_SERVICE}/api/v1/main/user/updaterestaurantAddress`, {
                method: 'PATCH',
                headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json'
    ...
    const saveProfile = () => {
        ...
        const { firstName, lastName, email, password, restaurantName, restaurantAddress } = values;
        const auth = getAuth();
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <Grid container spacing={3}>
                                        ...
                                        <TextField
                                            error={Boolean(touched.restaurantAddress && errors.restaurantAddress)}
                                            sx={{ width: '100%', m: 3 }}
                                            helperText={touched.restaurantAddress && errors.restaurantAddress}
                                        ...
                                        {changePassword ? (
                                            <Grid item md={6} xs={12}>
                                                <Button color="primary" fullWidth variant="text" onClick={() => setChangePassword(false)}>
                                                    change Password
                                                </Button>
                                            </Grid>
                                        ) : (
