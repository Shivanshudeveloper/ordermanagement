...
import { Box, Button, Container, Link, TextField, Typography, Snackbar, Alert, CardContent } from '@mui/material';
...
const Payment = ({ customer, cart, type, total, setShowPaymentHandler, setPaymentPendingHandler }) => {
    ...
    return (
        <>
            ...
            <Button sx={{ m: 0, mt: 1, p: 0 }} onClick={() => setShowPaymentHandler(false, null, total)}>
                        ...
                        {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
                            <form onSubmit={handleSubmit}>
                                ...
                                <Box sx={{ py: 2, display: 'flex', flexDirection: 'column' }}>
                                    <Button type="submit" variant="contained" disabled={paysubmit}>
