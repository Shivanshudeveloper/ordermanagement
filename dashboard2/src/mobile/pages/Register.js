...
import { Box, Button, Checkbox, Container, FormHelperText, TextField, Typography, Alert, Snackbar } from '@mui/material';
...
const Register = (props) => {
    ...
    return (
        <>
            ...
            <Button sx={{ m: 0, mt: 1, p: 0 }} onClick={() => navigate(`/mobile/signin/?${Query}`)}>
            ...
            >
                <Container maxWidth="sm">
                    ...
                    <Snackbar open={showSnackBar.show} autoHideDuration={6000} onClose={() => setShowSnackBar(false)}>
                        <Alert
                            onClose={() => setShowSnackBar({ show: false, error: false, message: '' })}
